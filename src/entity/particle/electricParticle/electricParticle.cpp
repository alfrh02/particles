...
ElectricParticle::ElectricParticle(vec2 pos, vec2 dir, float size, float speed, unsigned short lifespan, ofColor col)
: Particle(pos, dir, size, speed, lifespan, col) {

}

void ElectricParticle::update(double deltaTime) {
...
void ElectricParticle::onCollision(ofRectangle boundingBox) {
